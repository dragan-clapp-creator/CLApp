 ...
 *
 */
public class ResParser extends AParser {
  ...
  throws IOException {
    ...
    buffer.append( "{ " );
      ...
      isOk = ampersAndBlock4(parser, isOptional);
  ...
  public StringBuffer getRendering() {
    ...
    private boolean ampersAndBlock4(CLAppParser parser, boolean isOptional) throws IOException {
      int token = 0;
      Boolean b0 = null;
      Boolean b1 = null;
      Boolean b2 = null;
